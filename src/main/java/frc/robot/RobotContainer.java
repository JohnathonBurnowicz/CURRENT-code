...
import frc.robot.commands.DriveWithJoysticksSlow;
...
public class RobotContainer {
  ...
  private final DriveTrainSlow driveTrainSlow;
  private final DriveWithJoysticks driveWithJoysticks;
  private final DriveWithJoysticksSlow driveWithJoysticksSlow;
...
//Driver commands
    ...
    driveTrainSlow = new DriveTrainSlow();
    driveWithJoysticksSlow = new DriveWithJoysticksSlow(driveTrainSlow);
    driveWithJoysticksSlow.addRequirements(driveTrainSlow);
    driveTrainSlow.setDefaultCommand(driveWithJoysticksSlow);
